...
var calls = exports.requests = {
    ...
    GetLowestPricedOffersForSKU: function() {
        return new ProductsRequest('GetLowestPricedOffersForSKU', {
            MarketplaceId: { name: 'MarketplaceId', required: true},
            ItemCondition: { name: 'ItemCondition'},
    ...
    GetLowestPricedOffersForASIN: function() {
        return new ProductsRequest('GetLowestPricedOffersForASIN', {
            MarketplaceId: { name: 'MarketplaceId', required: true},
            ItemCondition: { name: 'ItemCondition'},
    ...
    GetMyFeesEstimate: function() {
        return new ProductsRequest('GetMyFeesEstimate', {
            FeesEstimateRequestList: { name: 'FeesEstimateRequestList.FeesEstimateRequest', list: true, required: true }
        });
    },
